...
uses
  ...
  FMXTreeControlColumnsDsgnPage,
  ADato.Controls.FMX.Tree.Impl, System.Classes;

type
  TTreeControlDesigner = class(TPageDesigner)
  protected
    _Control: TFMXTreeControl;
    _ColumnDesigner: TColumnsDesignPage;
    SampleControl: TFMXTreeControl;
    ...
    procedure set_Control(const Value: TFMXTreeControl); virtual;

  public
    property Control: TFMXTreeControl
      read  _Control
      write set_Control;
  end;
...
begin
  ...
  Editor.Control := TFMXTreeControl(AControl);
  Editor.Show;
end;
...
begin
  SampleControl := TFMXTreeControl.Create(Self);
...
procedure TTreeControlDesigner.set_Control(const Value: TFMXTreeControl);
begin
  _Control := Value;
