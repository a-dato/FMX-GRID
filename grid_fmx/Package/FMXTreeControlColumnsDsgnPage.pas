unit FMXTreeControlColumnsDsgnPage;
...
type
  ...
  protected
    ...
    _Control        : ADato.Controls.FMX.Tree.Intf.ITreeControl;
    _Modified       : Boolean;
...
var
  column : ADato.Controls.Tree.Intf.ITreeColumn;
...
begin
  ...
  column := ADato.Controls.Tree.Impl.TTreeColumn.Create;
...
begin
  ...
  begin
    case Dlg.cbColumnType.ItemIndex of
      0: _Column := TFMXTreeColumn.Create; // Indicator column
      1: _Column := TFMXTreeColumn.Create; // Indicator column
      2: _Column := TFMXTreeCheckboxColumn.Create; // Data bound column
    end;
